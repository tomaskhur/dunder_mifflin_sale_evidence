...
<head>
    ...
    <title>DunderMifflin | Add a new employee</title>
</head>
<body>
<header>
...
<section class="home-section">
    ...
    require 'db.php';
        ...
        $stmt = $pdo->prepare('SELECT * FROM tbEmployees WHERE name LIKE "%" :name "%" OR surname LIKE "%" :surname "%"');
        $stmt->execute(['name' => $search, 'surname' => $search]);
    ...
    <div class="employee-table">
        <div class="flex-employee">
            ...
            <div class="add-new-employee">
                <a href="employeeAdd.php"><h3>Add a new employee <i class="fa-solid fa-user-plus"></i></h3></a>
            </div>
        ...
        <table>
            ...
            foreach ($data as $key => $value) : ?>
                <tr>
                    ...
                    <td><a href="employeeAdd.php?id=<?= $value['id'] ?>"><i class="fa-solid fa-pen-to-square"></i></a></td>
                    <td> <a class="delete" href="deleteEmployee.php?id=<?= $value['id'] ?>"><i class="fa-solid fa-trash-can"></i></a></td>
                </tr>
            <?php endforeach;?>
